...
<body>
   <div class="container card  my-5">
      ...
      1. java파일
      2. 사용
      예) Dto(전달용도), Dao(db연결 → sql사용), DBManager, 필요한 api
      </pre>
      <!-- ctrl + space -->
