...
<body>
   <div class="container card  my-5">
      ...
      Class.forName("oracle.jdbc.driver.OracleDriver"); //회사명.프로젝트명.클래스명
      				//com.mysql.cj.jdbe.Driver          - mysql (중소기업)
      //2. db연결
      ...
      if(conn!= null){out.print("db연결성공!"); conn.close(); }
