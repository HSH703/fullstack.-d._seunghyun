...
#1. SPRING 특징
------------------------
▶ STEP0. JSP   MVC1 vs MVC2 차이점? (면접)
1. MVC1 -  JSP        - (CONTROLLER역할)  스파게티
2. MVC2 -  SERVLET - (CONTROLLER역할)  부품조립 ☆ 
...
3. 프레임워크의 특징
★(면접) IOC (Inversion of Control) 제어의 역전
...
DI ( Dependency Injection : 의존성 주입 )
  - 각 클래스 간의 의존관계  [설정파일]을 통해서 [컨테이너]가 자동으로 연결
