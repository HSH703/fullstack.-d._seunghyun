	...
	<form action="${pageContext.request.contextPath}/security/update"  
		...
		<div class="mb-3 mt-3">
			...
			<input  type="text" class="form-control" id="nickname"
					placeholder="닉네임을 입력해주세요" required  name="nickname"  value="${dto.nickname}"  readonly>
		</div>
		<div class="mb-3 mt-3">
			<label  for="mobile" class="form-label">Mobile:</label> 
			<input  type="text" class="form-control" id="mobile"
					placeholder="모바일을 입력해주세요" required  name="mobile"  value="${dto.mobile}"  readonly>
		</div>
		<div class="mb-3">
		...
		<div class="mb-3">
			<input type="text" class="form-control" id="ufile"
					readyonly name="ufile" value="${dto.ufile}">
		</div>
