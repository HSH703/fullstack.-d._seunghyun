 ...
 * ----------------------------------
 * ✅ Redux Store 설정파일
 * - Redux Toolkit의 configureStore 로 스토어 생성
 * - redux-saga 미들웨어
 * - next-redux-wrapper로 Next.js와 Redux 통합
 */

import { configureStore } from '@reduxjs/toolkit';   // ✅ Redux Toolkit 기본 스토어 생성 함수
...
export const makeStore = ()=>{
    ...
    const store = configureStore({
        ...
        getDefaultMiddleware({
         ...
         devTools: process.env.NODE_ENV !== 'production'  // ✅ 개발환경에서만 Redux Toolkit 활성화
    });
    // ✅ saga 실행(rootSaga 연결)
