...
public interface PostRepository extends JpaRepository<Post, Long> { //Entity , PK ★
   ...
   List<Post> findLikePostsWithPaging(@Param("userId") Long userId, @Param("start") int start, @Param("end") int end);
   ...
   List<Post> findMyPostAndRetweetWithPaging(@Param("userId") Long userId, @Param("start") int start, @Param("end") int end);
