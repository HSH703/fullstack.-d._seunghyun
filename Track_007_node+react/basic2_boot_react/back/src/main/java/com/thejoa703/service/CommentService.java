...
public class CommentService {
   ...
   // 해당 게시글의 댓글들 조회
    ...
    // 댓글 수정
    public CommentResponseDto updateComment(Long userId, Long commentReq, CommentRequestDto dto) {
        // 댓글조회
    	Comment comment = commentRepository.findById(commentReq)
    ...
    public void deleteComment(Long userId, Long commentId) {
        ...
        // 삭제 플래그 설정 (soft delete)
        comment.setDeleted(true);  
        commentRepository.save(comment);  // 수정 반영
    }
