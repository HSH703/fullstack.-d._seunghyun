 ...
 */
// ✅ 액션 타입 정의 type:  export const LOG_IN_REQUEST...
...
export const initialState={
    ...
    user: [],         // 전체 사용자 목록[ { id, email, nickname } ]
...
const reducer = ( state = initialState , action )=>{ 
    switch(action.type){
        ...
        case SIGN_UP_SUCCESS:
            return { ...state , isLoading:false, signUpDone:true }; //me:true

        case LOAD_USERS_SUCCESS:
            return { ...state , isLoading:false , users:action.data }; //me:action.data
