...
import { useDispatch } from "react-redux";  // store (치킨집) 상태확인
...
export default function OAuth2CallbackPage(){
    ...
    useEffect( ()=>{
        ...
        //http://localhost:3000/oauth2/callback?accessToken=eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJ0aGVqb2E3MDMiLCJzdWIiOiI2Iiwibmlja25hbWUiOiJTSCBIIiwiZW1haWwiOiJoNDgwOTc0MzVAZ21haWwuY29tIiwicHJvdmlkZXIiOiJnb29nbGUiLCJyb2xlIjoiUk9MRV9VU0VSIiwiaWF0IjoxNzY4OTU4MTUwLCJleHAiOjE3Njg5NTkwNTB9.QVWlZXgEpAXGTdj_mMWEw7Opw6wsDGJpO9Rlwe8z78A
        const { accessToken } = router.query;
        if(accessToken){
            try{
                localStorage.setItem("accessToken", accessToken);  // ## (15분짜리)토큰저장 
