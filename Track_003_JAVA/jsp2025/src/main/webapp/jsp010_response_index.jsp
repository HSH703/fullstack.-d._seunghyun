...
<body>
   <div class="container card  my-5">
      ...
      <pre class="alert alert-success">
      	1. response.sendRedirect - 브라우저url을 변경 / request, response가 유지X.
      	2. RequestDispatcher - 경로가 숨겨져서 안보임.  / request, response가 유지O.
      </pre>
      <pre class="alert alert-warning">
      1. Servlet - DeptWhat
      2. form    - 부서번호입력 
      3. DeptWhat 사용자정보를 요청처리후 요청값 주기 (dispatcher)
      
      [필요한파일]
      1. Dto (전달용)      - DeptDto
      2. Dao 서블릿에서 처리 - DeptWhat
      3. form - action(처리대상), method(get:검색/post:삽입), name
      4. jsp010_result.jsp파일 만들기(결과확인용)
      </pre>
