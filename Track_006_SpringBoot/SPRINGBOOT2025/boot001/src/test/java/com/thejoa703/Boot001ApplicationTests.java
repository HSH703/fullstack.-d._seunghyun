...
class Boot001ApplicationTests {
	...
	@Autowired Sboard2Service boardservice;
	 ...
	 @Test public void test3_sboard2Service() throws UnknownHostException {
			//1. selectAll
			...
			dto.setBip( Inet4Address.getLocalHost().getHostAddress() );
	...
	@Disabled  @Test void contextLoads() {   //JUnit 4 : @Ignore / JUnit 5: @Disabled
...
//		System.out.println("......" + dto.getAge());
	...
	@Disabled  @Test void serviceTest1() { System.out.println("......" + service.readTime()); }
...
//		//4. update
//		Sboard2Dto dto_u = new Sboard2Dto();
//		dto_u.setBtitle("title-new"); dto_u.setBcontent("content-new"); dto_u.setBpass("1111");
//		dto_u.setId(1); 
